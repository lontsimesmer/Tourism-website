  ...
  return (
    <div className="aboutContent">
      <div className="content">
        <img
          src="https://www.km2k.co.za/wp-content/uploads/2015/07/FinalRTM_5181.jpg"
          alt="village"
        />
        <p>
      ...
      <div className="content">
        ...
        <img
          src="https://pict.sindonews.net/dyn/620/pena/news/2020/12/05/34/257570/dibayarin-apbn-jembatan-gantung-situ-gunung-terpanjang-di-asia-tenggara-wzd.jpg"
          alt="crossing"
        />
      </div>
      ...
      <div className="content">
        <img
          src="https://selectadventuresafari.com/wp-content/uploads/2021/02/lake-kivu-rwanda.jpg"
          alt="lake kive"
        />
        <p>
